...
def get_index(i,j,orb):
    ...
    orb:   0  px1; 1 py1; 2  pz1; 3 px2; 4 py2; 5 pz2
    ...
    return orb+6*(j+M)+6*(2*M+1)*(i+M)+5 
...
def create_static_eom_matrix(prm):
    ...
    if val != 0.0:
        row.append(row_index)
        col.append(get_index(0,0,4))
        data.append(val)
        row.append(get_index(0,0,4))
        col.append(row_index)
        data.append(val)
    # hop down
    val = pds/2.0
    if val != 0.0:
        row.append(row_index)
        col.append(get_index(0,1,4))
        data.append(val)
        row.append(get_index(0,1,4))
        col.append(row_index)
        data.append(val)
    #-------------------------------------------------       
    # orb = dx2y2
    ...
    if val != 0.0:
        row.append(row_index)
        col.append(get_index(1,0,2))
        data.append(val)
        row.append(get_index(1,0,2))
        col.append(row_index)
        data.append(val)
    # hop right
    val = pdp
    ...
    if val != 0.0:
        row.append(row_index)
        col.append(get_index(0,0,5))
        data.append(val)
        row.append(get_index(0,0,5))
        col.append(row_index)
        data.append(val)
    # hop down
    val = -pdp
    if val != 0.0:
        row.append(row_index)
        col.append(get_index(0,1,5))
        data.append(val)
        row.append(get_index(0,1,5))
        col.append(row_index)
        data.append(val)
    ...
    for i in range(-M,M+1):
        for j in range(-M,M+1):   
            ...
            if val != 0.0:
                row.append(row_index)
                col.append(get_index(i,j,4))
                data.append(val)
                row.append(get_index(i,j,4))
                col.append(row_index)
                data.append(val)
            # hop down left
            if j < M:
                ...
                if val != 0.0:
                    row.append(row_index)
                    col.append(get_index(i,j+1,4))
                    data.append(val)
                    row.append(get_index(i,j+1,4))
                    col.append(row_index)
                    data.append(val)
            # hop down right
            if i > -M and j < M:
                ...
                if val != 0.0:
                    row.append(row_index)
                    col.append(get_index(i-1,j+1,4))
                    data.append(val)
                    row.append(get_index(i-1,j+1,4))
                    col.append(row_index)
                    data.append(val)
            # hop up right
            if i > -M:
                ...
                if val != 0.0:
                    row.append(row_index)
                    col.append(get_index(i-1,j,4))
                    data.append(val)
                    row.append(get_index(i-1,j,4))
                    col.append(row_index)
                    data.append(val)
            #----------------------------------------------------   
            # orb = py1
