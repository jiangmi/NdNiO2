...
if Norb==8:
    ...
    #tNiOs = 0.01 
    tOsOs = 0.23
    tOsOs_p = 0.44  # hopping between two planes
...
# set Ni-Os hopping from no_eh states or one_eh states:
set_tNiOs_from = 'no-eh'  # 'one-eh'

eh_spin_def = 'same'  # 'oppo'
...
if if_compute_Aw==1:
    ...
    if if_find_lowpeak==1:
        peak_mode = 'highest_peak' # 'lowest_peak' or 'highest_peak' or 'lowest_peak_intensity'
...
print ("Ovacancy_orbs = ",  Ovacancy_orbs)
orbs = Ni_orbs + O_orbs + Ovacancy_orbs
